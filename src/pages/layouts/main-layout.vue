...
<template>
  <div class="flex flex-row min-h-screen bg-gray text-gray-800">
    <aside
    ...
    >
      <div class="sidebar-header flex px-6 py-6">
        <div class="inline-flex">
          <a href="#" class="inline-flex flex-row items-center">
            ...
            >
              <circle cx="41" cy="17" r="17" fill="#C9EE44" />
      ...
      <div class="sidebar-content px-4 py-6">
        <ul class="flex flex-col w-full">
          ...
          <li class="my-px">
            <span
              class="flex font-medium text-sm text-grayLight px-4 my-4 uppercase"
              >Projects</span
            >
          </li>
          <li class="my-px">
            <a
              href="#"
              class="flex flex-row items-center h-10 px-3 rounded-lg text-grayLight hover:bg-green hover:text-black"
            >
              <span
                class="flex items-center justify-center text-lg text-gray-400"
              >
